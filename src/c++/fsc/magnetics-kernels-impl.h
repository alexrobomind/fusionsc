...
/**
 \ingroup kernels
 */
EIGEN_DEVICE_FUNC void addFieldKernel(unsigned int idx, FieldRef out, FieldRef in, double scale) {
	out.data()[idx] += in.data()[idx] * scale;
}

EIGEN_DEVICE_FUNC void addFieldInterpKernel(unsigned int idx, FieldRef out, ToroidalGridStruct gridOut, FieldRef in, ToroidalGridStruct gridIn, double scale) {
...
/**
 \ingroup kernels
 */
EIGEN_DEVICE_FUNC void biotSavartKernel(unsigned int idx, ToroidalGridStruct grid, FilamentRef filament, double current, double coilWidth, double stepSize, FieldRef out) {
	int midx[3];
...
/**
 \ingroup kernels
 */
EIGEN_DEVICE_FUNC void eqFieldKernel(unsigned int idx, ToroidalGridStruct grid, fsc::cu::AxisymmetricEquilibrium::Reader equilibrium, double scale, FieldRef out) {
	int midx[3];
