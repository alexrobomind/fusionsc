...
namespace fsc {
	...
	*/
	...
	EIGEN_DEVICE_FUNC void fltKernel(
		...
		fsc::cu::FLTKernelData::Builder kernelData,
		TensorMap<Tensor<double, 4>> fieldData,
		fsc::cu::FLTKernelRequest::Builder kernelRequest,
		
		fsc::cu::MergedGeometry::Reader geometry,
		fsc::cu::IndexedGeometry::Reader index,
		fsc::cu::IndexedGeometry::IndexData::Reader indexData,
		
		fsc::cu::ReversibleFieldlineMapping::Reader flmData
	) {
		using Num = double;
		using V3 = Vec3<Num>;
		using V2 = Vec2<Num>;
