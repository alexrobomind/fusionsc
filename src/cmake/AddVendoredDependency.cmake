...
macro(add_vendored_dependency)
	...
	if((NOT FSC_DEP_PREF_VENDORED OR NOT FSC_DEP_ALLOW_VENDORED) AND NOT FSC_DEP_${AVDARGS_NAME}_PREF_VENDORED AND NOT (DEFINED FSC_DEP_${AVDARGS_NAME}_STRATEGY AND FSC_DEP_${AVDARGS_NAME}_STRATEGY STREQUAL "vendored"))
