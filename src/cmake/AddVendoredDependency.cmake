...
option(FSC_DEP_PREF_VENDORED "Whether to preferentially use vendored dependencies" Off)
...
macro(add_vendored_dependency)
	...
	if(NOT SKBUILD AND NOT FSC_DEP_PREF_VENDORED AND NOT FSC_DEP_${AVDARGS_NAME}_PREF_VENDORED AND NOT (DEFINED FSC_DEP_${AVDARGS_NAME}_STRATEGY AND FSC_DEP_${AVDARGS_NAME}_STRATEGY STREQUAL "vendored"))
