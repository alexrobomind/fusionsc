...
namespace goldfish
{
	...
	{
		auto document = json::read(stream::read_string_literal("[\"hello\"]"), throw_on_error{}).as_array();
	...
	{
		auto document = json::read(stream::read_string_literal("[[1, 2]]"), throw_on_error{}).as_array();
	...
	{
		auto document = json::read(stream::read_string_literal("[{\"a\":1, \"b\":2}]"), throw_on_error{}).as_array();
